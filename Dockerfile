...
RUN echo 'deb http://apt.postgresql.org/pub/repos/apt/ wheezy-pgdg main 9.5' >> /etc/apt/sources.list \
 && wget -O- -q http://apt.postgresql.org/pub/repos/apt/ACCC4CF8.asc | apt-key add -
